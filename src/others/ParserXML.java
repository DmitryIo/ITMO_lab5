...
public class ParserXML {
    ...
    private static final int NUMBER_OF_TOKENS = 12;
    private int tokensOffset, valuesOffset, textOffset, groupsNum;
    private String[] values;
    private String[] tokens = {"<Name>", "<X>", "<Y>", "<CreationDate>", "<studentsCount>", "<formOfEducation>",
            "<semesterEnum>", "<Name>", "<weight>", "<passportID>", "<eyeColor>", "<nationality>", "<StudyGroup>"};
    private char[] text;
    ...
    /**
     * Method for getting a number of groups from a file.
     * @return returns number of products
     */

    public int getGroupsNum() {return groupsNum;}
